...
{
	public partial class NotasSalas : Form
	{
		...
		private void NOTASSALAS_Load(object sender, EventArgs e)
		{
		...
		{
			salaProfessor = new SalaProfessor();
			this.Hide();
			salaProfessor.ShowDialog();
			this.Show();
		}// botao pra consultar as salas do professor

		private void button1_Click(object sender, EventArgs e)
		{
			notasProfessor = new NotasProfessor();
			this.Hide();
			notasProfessor.ShowDialog();
			this.Show();
        }// botao pra gerenciar as notas dos alunos
	}
}
