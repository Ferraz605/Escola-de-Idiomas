...
{
	public partial class ExcluirSalas : Form
	{
		DAOSalas daoSalas;
		Salas salas;
		public ExcluirSalas()
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			else
			{
				...
				string msg = this.daoSalas.DeletarSalas(codigo);
				MessageBox.Show(msg);
		...
		{
			this.Close();
		}// botao de voltar para a tela de gerenciamento de salas

		private void ExcluirSalas_Load(object sender, EventArgs e)
		{
