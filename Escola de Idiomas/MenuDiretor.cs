...
{
	public partial class MenuDiretor : Form
	{
		Salas salas;
		Cursos cursos;
		public MenuDiretor()
		...
		private void button1_Click(object sender, EventArgs e)
		{
			salas = new Salas();
			salas.ShowDialog();
		}// botao de ir pra tela das salas

		private void button2_Click(object sender, EventArgs e)
		{
			cursos = new Cursos();
			cursos.ShowDialog();
		}// botao de ir pra tela das cursos

		private void MenuDiretor_Load(object sender, EventArgs e)
		{
